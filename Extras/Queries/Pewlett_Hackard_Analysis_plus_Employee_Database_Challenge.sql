-- Schema and Queries for Module 7 SQL saved in this file as well.
-- Scroll down to line 226 for MODULE 7 SQL Challenge
...
-- Added eligible employees to new table
SELECT first_name, last_name
...
-- Join retirement_info and dept_emp tables and add them to a new table
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
	de.to_date
...
-- Employee Information with current salaries listed
SELECT e.emp_no,
    e.first_name,
	e.last_name,
    e.gender,
...
-- Sales department retiree information
SELECT ce.emp_no,
	ce.first_name,
	ce.last_name,
	d.dept_name
INTO sales_dept_retiree_eligibility
FROM current_emp AS ce
	INNER JOIN dept_emp AS de
		ON (ce.emp_no = de.emp_no)
	INNER JOIN departments AS d
...
-- Sales and Development department retiree information
SELECT ce.emp_no,
	ce.first_name,
	ce.last_name,
	d.dept_name
INTO sales_development_dept_retiree_eligibility
FROM current_emp AS ce
	INNER JOIN dept_emp AS de
		ON (ce.emp_no = de.emp_no)
	INNER JOIN departments AS d
